...
#SBATCH --output=/home/dungnt206/workspace/code/DynamiCrafter/logs/dummy/output_file_rand.txt
#SBATCH --error=/home/dungnt206/workspace/code/DynamiCrafter/logs/dummy/error_file_rand.txt
...
python3 -m torch.distributed.launch \
    --nproc_per_node=$HOST_GPU_NUM --nnodes=1 --master_addr=127.0.0.1 --master_port=12355 --node_rank=0 \
    ./main/trainer.py \
    --base $config_file \
    --train \
    --name $name \
