...
ckpt='/home/dungnt206/workspace/pretrain/huggingface/dynamicrafter/model.ckpt'
...
# Now that the previous if-else block is closed, you can safely proceed with your else statements
if [ "$1" -eq "256" ]; then
