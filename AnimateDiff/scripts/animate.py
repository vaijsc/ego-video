...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained-model-path", type=str, default="/home/dungnt206/workspace/huggingface/stable-diffusion-2-1-base") #runwayml/stable-diffusion-v1-5
