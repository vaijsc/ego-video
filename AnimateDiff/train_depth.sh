...
# Start training
$(conda run -n animated which torchrun) --nnodes=1 --nproc_per_node=3 --master_port=29592 train.py --config configs/training/v2/training_smth_curated_20_depth.yaml --tensorboard > logfile.log 2>&1 &
